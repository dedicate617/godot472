...
void WebViewOverlay::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_context_menus_enable", "context_menus_enable"), &WebViewOverlay::set_context_menus_enable);
	ClassDB::bind_method(D_METHOD("get_context_menus_enable"), &WebViewOverlay::get_context_menus_enable);
	...
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "context_menus_enable"), "set_context_menus_enable", "get_context_menus_enable");
...
void WebViewOverlay::_draw_placeholder() {
	...
	Size2 url_size = font->get_string_size(home_url);
	font->draw_string(get_canvas_item(), Vector2((size.x - url_size.x) / 2, 100 + url_size.y) + Vector2(1, 1), home_url, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - url_size.x) / 2, 100 + url_size.y) + Vector2(-1, 1), home_url, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - url_size.x) / 2, 100 + url_size.y) + Vector2(1, -1), home_url, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - url_size.x) / 2, 100 + url_size.y) + Vector2(-1, -1), home_url, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - url_size.x) / 2, 100 + url_size.y), home_url, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(1, 1, 1));
}
...
void WebViewOverlay::_draw_error(const String &p_error) {
	...
	Size2 er_size = font->get_string_size(p_error);
	Size2 ti_size = font->get_string_size(err_ti);
	
	font->draw_string(get_canvas_item(), Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) + Vector2(1, 1), err_ti, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) + Vector2(-1, 1), err_ti, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) + Vector2(1, -1), err_ti, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) + Vector2(-1, -1), err_ti, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y), err_ti, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(1, 0, 0));
	
	font->draw_string(get_canvas_item(), Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) + Vector2(1, 1), p_error, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) + Vector2(-1, 1), p_error, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) + Vector2(1, -1), p_error, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) + Vector2(-1, -1), p_error, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(0, 0, 0, 0.5));
	font->draw_string(get_canvas_item(), Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y), p_error, HORIZONTAL_ALIGNMENT_LEFT, -1.0F, 16, Color(1, 0, 0));
}
