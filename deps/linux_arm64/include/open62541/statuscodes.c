...
#else
static const size_t statusCodeDescriptionsSize = 263;
static const UA_StatusCodeName statusCodeDescriptions[263] = {
    ...
    {UA_STATUSCODE_UNCERTAINTRANSDUCERINMANUAL, "UncertainTransducerInManual"},
    {UA_STATUSCODE_UNCERTAINSIMULATEDVALUE, "UncertainSimulatedValue"},
    {UA_STATUSCODE_UNCERTAINSENSORCALIBRATION, "UncertainSensorCalibration"},
    {UA_STATUSCODE_UNCERTAINCONFIGURATIONERROR, "UncertainConfigurationError"},
    {UA_STATUSCODE_GOODCASCADEINITIALIZATIONACKNOWLEDGED, "GoodCascadeInitializationAcknowledged"},
    {UA_STATUSCODE_GOODCASCADEINITIALIZATIONREQUEST, "GoodCascadeInitializationRequest"},
    {UA_STATUSCODE_GOODCASCADENOTINVITED, "GoodCascadeNotInvited"},
    {UA_STATUSCODE_GOODCASCADENOTSELECTED, "GoodCascadeNotSelected"},
    {UA_STATUSCODE_GOODFAULTSTATEACTIVE, "GoodFaultStateActive"},
    {UA_STATUSCODE_GOODINITIATEFAULTSTATE, "GoodInitiateFaultState"},
    {UA_STATUSCODE_GOODCASCADE, "GoodCascade"},
